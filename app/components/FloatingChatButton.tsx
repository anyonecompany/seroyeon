...
export default function FloatingChatButton() {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-44 right-5 z-40 w-12 h-12 rounded-full bg-[#FEE500] shadow-lg shadow-black/15 flex items-center justify-center active:scale-90 transition-transform"
      aria-label="카카오톡 문의"
    >
